...
/*
 * Init sequence extracted from the stock Samsung firmware DSI trace.
 * Confirmed working on HX83102-E.
 */
static int innolux_hx83102e_inx_fhd_init(struct hx83102 *ctx)
{
	struct mipi_dsi_multi_context dsi_ctx = { .dsi = ctx->dsi };

	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETEXTC, 0x83, 0x10, 0x2e);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETPCTRL, 0x67, 0x0c, 0xff, 0x05);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETPOWER,
				0x10, 0xfa, 0xaf, 0xaf, 0x2b, 0x2b, 0xa2, 0x44,
				0x59, 0x38, 0x38, 0x38, 0x38, 0x22, 0x21, 0x15,
				0x00
	);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_UNKNOWN_D2, 0x2b, 0x2b);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETDISP,
				0x00, 0xb0, 0x47, 0xd0, 0x00, 0x2c, 0x2c, 0x2c,
				0x00, 0x00, 0x00, 0x00, 0x15, 0x20, 0xd7, 0x00
	);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETCYC,
				0x88, 0x64, 0x01, 0x01, 0x88, 0x64, 0x68, 0x50,
				0x01, 0x8e, 0x01, 0x58, 0x00, 0xff, 0x00, 0xff
	);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETMIPI, 0x70, 0x03, 0xa8, 0x85, 0xb2, 0x00, 0xc0);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETPTBA, 0xfc, 0x85, 0x80);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETSTBA,
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETTCON, 0x30);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETRAMDMY,
				0x00, 0x04, 0x04, 0x00, 0x00, 0x82, 0x13, 0xff
	);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETCASCADE, 0x07, 0x04, 0x05);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETGIP0,
				0x00, 0x00, 0x00, 0x00, 0x3c, 0x04, 0x00, 0x0c,
				0x0c, 0x4b, 0x40, 0x44, 0x4f, 0x2b, 0x2b, 0x04,
				0x04, 0x32, 0x10, 0x29, 0x00, 0x29, 0x54, 0x17,
				0xfb, 0x07, 0xfb, 0x32, 0x10, 0x10, 0x00, 0x10,
	...
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETGIP1,
				...
				0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18,
				0x18, 0x18, 0x27, 0x26, 0x25, 0x24, 0x1a, 0x1a,
				0x1b, 0x1b, 0x0b, 0x0a, 0x09, 0x08, 0x07, 0x06,
				0x05, 0x04, 0x03, 0x02, 0x01, 0x00, 0x21, 0x20,
				0x18, 0x18, 0x18, 0x18
	);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETGIP2,
				0x98, 0x98, 0x98, 0x98, 0x98, 0x98, 0x98, 0x98,
				0x98, 0x98, 0x98, 0x98, 0x98, 0x98, 0x98, 0x98,
				0x18, 0x18, 0x26, 0x27, 0x20, 0x21, 0x1a, 0x1a,
				0x1b, 0x1b, 0x08, 0x09, 0x0a, 0x0b, 0x00, 0x01,
				0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x24, 0x25,
				0x18, 0x18, 0x18, 0x18
	);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETGMA,
				0x00, 0x04, 0x0b, 0x11, 0x19, 0x2a, 0x42, 0x4a,
				0x53, 0x51, 0x6e, 0x77, 0x81, 0x93, 0x95, 0xa0,
				0xaa, 0xbd, 0xbb, 0x59, 0x5b, 0x5f, 0x65, 0x00,
				0x04, 0x0b, 0x11, 0x19, 0x2a, 0x42, 0x4a, 0x53,
				0x51, 0x6e, 0x77, 0x81, 0x93, 0x95, 0xa0, 0xaa,
				0xbd, 0xbe, 0x5e, 0x67, 0x70, 0x73
	);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETTP1,
				0x12, 0x13, 0x02, 0x02, 0x55, 0x00, 0x0e, 0x0e,
				0x00, 0x26, 0x27, 0x74, 0x0d, 0x73, 0x01, 0x27,
				0x00, 0x00, 0x00, 0x00, 0x17, 0x00, 0x68
	);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETBANK, 0x01);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETPOWER, 0x01, 0x9b, 0x01, 0x31);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETCLOCK,
				0x80, 0x36, 0x12, 0x16, 0xc0, 0x28, 0x54, 0x84,
				0x02, 0x34
	);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETGIP0,
				0x01, 0x00, 0xf8, 0x00, 0x00, 0x11, 0x10, 0x00,
				0x0a, 0x00, 0x01
	);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETTP1, 0x02, 0x30, 0x01, 0x94, 0x0d, 0xc4, 0x0e);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETBANK, 0x02);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETCYC, 0x4e, 0x00, 0x33, 0x11, 0x33, 0x88);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETPTBA, 0xf2, 0x00, 0x02);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETTP1,
				0xfd, 0x01, 0xfd, 0x01, 0x00, 0x00, 0x24, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x81, 0x00, 0x02, 0x40
	);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETGIP3,
				0xff, 0xff, 0xfc, 0x3f, 0xff, 0xf0, 0xff, 0xff,
				0xfc, 0x3f, 0xff, 0xf0
	);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETBANK, 0x03);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETGIP3,
				0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xa0, 0xaa, 0xaa,
				0xaa, 0xaa, 0xaa, 0xa0, 0xff, 0xff, 0xfc, 0x3f,
				0xff, 0xf0, 0xff, 0xff, 0xfc, 0x3f, 0xff, 0xf0
	);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETBANK, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETSPCCMD, 0xcd);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_UNKNOWN_BB, 0x01);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETSPCCMD, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_UNKNOWN_B8, 0x40, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETBANK, 0x01);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_UNKNOWN_B8, 0x15);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETBANK, 0x00);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETPANEL, 0x02);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_UNKNOWN_E1, 0x00, 0x0a);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, 0x53, 0x2c);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETPWM, 0x00, 0x0e, 0x10);
	mipi_dsi_dcs_write_seq_multi(&dsi_ctx, HX83102_SETEXTC, 0x00, 0x00, 0x00);
...
static const struct drm_display_mode innolux_hx83102e_inx_fhd_mode = {
	.clock = 158882,
	.hdisplay = 1200,
	.hsync_start = 1200 + 24,
	.hsync_end = 1200 + 24 + 20,
	.htotal = 1200 + 24 + 20 + 23,
	.vdisplay = 2000,
	.vsync_start = 2000 + 44,
	.vsync_end = 2000 + 44 + 8,
	.vtotal = 2000 + 44 + 8 + 38,
...
static const struct hx83102_panel_desc innolux_hx83102e_inx_fhd_desc = {
	.modes = &innolux_hx83102e_inx_fhd_mode,
	.size = {
		.width_mm = 135,
		.height_mm = 226,
	},
	.mode_flags = MIPI_DSI_MODE_VIDEO |
		      MIPI_DSI_MODE_LPM,
	.has_backlight = true,
	.init = innolux_hx83102e_inx_fhd_init,
};
...
static const struct of_device_id hx83102_of_match[] = {
	...
	{ .compatible = "innolux,hx83102e-inx-fhd",
	  .data = &innolux_hx83102e_inx_fhd_desc
	},
	{ /* sentinel */ }
};

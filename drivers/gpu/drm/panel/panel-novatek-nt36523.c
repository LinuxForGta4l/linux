...
static int gta4l_lide_hsd_init_sequence(struct panel_info *pinfo)
{
	...
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x20);
	mipi_dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x05, 0xc9);
	mipi_dsi_dcs_write_seq(dsi, 0x06, 0xc0);
	mipi_dsi_dcs_write_seq(dsi, 0x07, 0x87);
	mipi_dsi_dcs_write_seq(dsi, 0x08, 0x37);
	mipi_dsi_dcs_write_seq(dsi, 0x0d, 0x63);
	mipi_dsi_dcs_write_seq(dsi, 0x0e, 0xa5);
	mipi_dsi_dcs_write_seq(dsi, 0x0f, 0x55);
	mipi_dsi_dcs_write_seq(dsi, 0x94, 0xc0);
	mipi_dsi_dcs_write_seq(dsi, 0x95, 0x09);
	mipi_dsi_dcs_write_seq(dsi, 0x96, 0x09);
	mipi_dsi_dcs_write_seq(dsi, 0x58, 0x60);
	mipi_dsi_dcs_write_seq(dsi, 0x75, 0xa2);
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x20);
	mipi_dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xb0, 0x00, 0x08, 0x00, 0x2a, 0x00, 0x5b, 0x00, 0x80, 0x00, 0x9f, 0x00, 0xb9, 0x00, 0xd0, 0x00, 0xe4);
	mipi_dsi_dcs_write_seq(dsi, 0xb1, 0x00, 0xf6, 0x01, 0x31, 0x01, 0x59, 0x01, 0x9a, 0x01, 0xc5, 0x02, 0x0a, 0x02, 0x3a, 0x02, 0x3c);
	mipi_dsi_dcs_write_seq(dsi, 0xb2, 0x02, 0x6d, 0x02, 0xa9, 0x02, 0xd8, 0x03, 0x0b, 0x03, 0x36, 0x03, 0x63, 0x03, 0x72, 0x03, 0x80);
	mipi_dsi_dcs_write_seq(dsi, 0xb3, 0x03, 0x91, 0x03, 0xa3, 0x03, 0xb8, 0x03, 0xcc, 0x03, 0xd9, 0x03, 0xdb);
	mipi_dsi_dcs_write_seq(dsi, 0xb4, 0x00, 0x08, 0x00, 0x2a, 0x00, 0x5b, 0x00, 0x80, 0x00, 0x9f, 0x00, 0xb9, 0x00, 0xd0, 0x00, 0xe4);
	mipi_dsi_dcs_write_seq(dsi, 0xb5, 0x00, 0xf6, 0x01, 0x31, 0x01, 0x59, 0x01, 0x9a, 0x01, 0xc5, 0x02, 0x0a, 0x02, 0x3a, 0x02, 0x3c);
	mipi_dsi_dcs_write_seq(dsi, 0xb6, 0x02, 0x6d, 0x02, 0xa9, 0x02, 0xd8, 0x03, 0x0b, 0x03, 0x36, 0x03, 0x63, 0x03, 0x72, 0x03, 0x80);
	mipi_dsi_dcs_write_seq(dsi, 0xb7, 0x03, 0x91, 0x03, 0xa3, 0x03, 0xb8, 0x03, 0xcc, 0x03, 0xd9, 0x03, 0xdb);
	mipi_dsi_dcs_write_seq(dsi, 0xb8, 0x00, 0x08, 0x00, 0x2a, 0x00, 0x5b, 0x00, 0x80, 0x00, 0x9f, 0x00, 0xb9, 0x00, 0xd0, 0x00, 0xe4);
	mipi_dsi_dcs_write_seq(dsi, 0xb9, 0x00, 0xf6, 0x01, 0x31, 0x01, 0x59, 0x01, 0x9a, 0x01, 0xc5, 0x02, 0x0a, 0x02, 0x3a, 0x02, 0x3c);
	mipi_dsi_dcs_write_seq(dsi, 0xba, 0x02, 0x6d, 0x02, 0xa9, 0x02, 0xd8, 0x03, 0x0b, 0x03, 0x36, 0x03, 0x63, 0x03, 0x72, 0x03, 0x80);
	mipi_dsi_dcs_write_seq(dsi, 0xbb, 0x03, 0x91, 0x03, 0xa3, 0x03, 0xb8, 0x03, 0xcc, 0x03, 0xd9, 0x03, 0xdb);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xe1, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xe2, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xe3, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x21);
	mipi_dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xb0, 0x00, 0x00, 0x00, 0x22, 0x00, 0x53, 0x00, 0x78, 0x00, 0x97, 0x00, 0xb1, 0x00, 0xc8, 0x00, 0xdc);
	mipi_dsi_dcs_write_seq(dsi, 0xb1, 0x00, 0xee, 0x01, 0x29, 0x01, 0x51, 0x01, 0x92, 0x01, 0xbd, 0x02, 0x02, 0x02, 0x32, 0x02, 0x34);
	mipi_dsi_dcs_write_seq(dsi, 0xb2, 0x02, 0x65, 0x02, 0xa1, 0x02, 0xd0, 0x03, 0x03, 0x03, 0x2e, 0x03, 0x5b, 0x03, 0x6a, 0x03, 0x78);
	mipi_dsi_dcs_write_seq(dsi, 0xb3, 0x03, 0x89, 0x03, 0x9b, 0x03, 0xb0, 0x03, 0xc4, 0x03, 0xd1, 0x03, 0xd3);
	mipi_dsi_dcs_write_seq(dsi, 0xb4, 0x00, 0x00, 0x00, 0x22, 0x00, 0x53, 0x00, 0x78, 0x00, 0x97, 0x00, 0xb1, 0x00, 0xc8, 0x00, 0xdc);
	mipi_dsi_dcs_write_seq(dsi, 0xb5, 0x00, 0xee, 0x01, 0x29, 0x01, 0x51, 0x01, 0x92, 0x01, 0xbd, 0x02, 0x02, 0x02, 0x32, 0x02, 0x34);
	mipi_dsi_dcs_write_seq(dsi, 0xb6, 0x02, 0x65, 0x02, 0xa1, 0x02, 0xd0, 0x03, 0x03, 0x03, 0x2e, 0x03, 0x5b, 0x03, 0x6a, 0x03, 0x78);
	mipi_dsi_dcs_write_seq(dsi, 0xb7, 0x03, 0x89, 0x03, 0x9b, 0x03, 0xb0, 0x03, 0xc4, 0x03, 0xd1, 0x03, 0xd3);
	mipi_dsi_dcs_write_seq(dsi, 0xb8, 0x00, 0x00, 0x00, 0x22, 0x00, 0x53, 0x00, 0x78, 0x00, 0x97, 0x00, 0xb1, 0x00, 0xc8, 0x00, 0xdc);
	mipi_dsi_dcs_write_seq(dsi, 0xb9, 0x00, 0xee, 0x01, 0x29, 0x01, 0x51, 0x01, 0x92, 0x01, 0xbd, 0x02, 0x02, 0x02, 0x32, 0x02, 0x34);
	mipi_dsi_dcs_write_seq(dsi, 0xba, 0x02, 0x65, 0x02, 0xa1, 0x02, 0xd0, 0x03, 0x03, 0x03, 0x2e, 0x03, 0x5b, 0x03, 0x6a, 0x03, 0x78);
	mipi_dsi_dcs_write_seq(dsi, 0xbb, 0x03, 0x89, 0x03, 0x9b, 0x03, 0xb0, 0x03, 0xc4, 0x03, 0xd1, 0x03, 0xd3);
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x23);
	mipi_dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x80);
	mipi_dsi_dcs_write_seq(dsi, 0x07, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x08, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x09, 0x2c);
	mipi_dsi_dcs_write_seq(dsi, 0x11, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x12, 0x77);
	mipi_dsi_dcs_write_seq(dsi, 0x15, 0x07);
	mipi_dsi_dcs_write_seq(dsi, 0x16, 0x07);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x92, 0xd4);
	mipi_dsi_dcs_write_seq(dsi, 0x93, 0x1a);
	mipi_dsi_dcs_write_seq(dsi, 0x94, 0x08);
	mipi_dsi_dcs_write_seq(dsi, 0xc2, 0xca);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x05, 0x22);
	mipi_dsi_dcs_write_seq(dsi, 0x06, 0x23);
	mipi_dsi_dcs_write_seq(dsi, 0x07, 0x1c);
	mipi_dsi_dcs_write_seq(dsi, 0x08, 0x1d);
	mipi_dsi_dcs_write_seq(dsi, 0x09, 0x0c);
	mipi_dsi_dcs_write_seq(dsi, 0x0a, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0x0b, 0x0e);
	mipi_dsi_dcs_write_seq(dsi, 0x0c, 0x0f);
	mipi_dsi_dcs_write_seq(dsi, 0x0d, 0x04);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x1b, 0x22);
	mipi_dsi_dcs_write_seq(dsi, 0x1c, 0x23);
	mipi_dsi_dcs_write_seq(dsi, 0x1d, 0x1c);
	mipi_dsi_dcs_write_seq(dsi, 0x1e, 0x1d);
	mipi_dsi_dcs_write_seq(dsi, 0x1f, 0x0c);
	mipi_dsi_dcs_write_seq(dsi, 0x20, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0x21, 0x0e);
	mipi_dsi_dcs_write_seq(dsi, 0x22, 0x0f);
	mipi_dsi_dcs_write_seq(dsi, 0x23, 0x04);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x30, 0x41);
	mipi_dsi_dcs_write_seq(dsi, 0x33, 0x42);
	mipi_dsi_dcs_write_seq(dsi, 0x34, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0x37, 0x33);
	mipi_dsi_dcs_write_seq(dsi, 0x3a, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0x3b, 0xd0);
	mipi_dsi_dcs_write_seq(dsi, 0x3d, 0x52);
	mipi_dsi_dcs_write_seq(dsi, 0xab, 0x22);
	mipi_dsi_dcs_write_seq(dsi, 0x4d, 0x21);
	mipi_dsi_dcs_write_seq(dsi, 0x4e, 0x43);
	mipi_dsi_dcs_write_seq(dsi, 0x51, 0x34);
	mipi_dsi_dcs_write_seq(dsi, 0x52, 0x12);
	mipi_dsi_dcs_write_seq(dsi, 0x55, 0x42, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0x56, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0x58, 0x21);
	mipi_dsi_dcs_write_seq(dsi, 0x59, 0x30);
	mipi_dsi_dcs_write_seq(dsi, 0x5a, 0x05);
	mipi_dsi_dcs_write_seq(dsi, 0x5b, 0xb0);
	mipi_dsi_dcs_write_seq(dsi, 0x5c, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x5d, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x5e, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x5f, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x65, 0x82);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x7e, 0x20);
	mipi_dsi_dcs_write_seq(dsi, 0x7f, 0x3c);
	mipi_dsi_dcs_write_seq(dsi, 0x80, 0x50);
	mipi_dsi_dcs_write_seq(dsi, 0x82, 0x88);
	mipi_dsi_dcs_write_seq(dsi, 0x97, 0xc2);
	mipi_dsi_dcs_write_seq(dsi, 0xc3, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xc4, 0x20);
	mipi_dsi_dcs_write_seq(dsi, 0xdb, 0x72);
	mipi_dsi_dcs_write_seq(dsi, 0xdc, 0xcd);
	mipi_dsi_dcs_write_seq(dsi, 0xdf, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xe0, 0xcd);
	mipi_dsi_dcs_write_seq(dsi, 0xe1, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xe2, 0xcd);
	mipi_dsi_dcs_write_seq(dsi, 0xe3, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xe4, 0xcd);
	mipi_dsi_dcs_write_seq(dsi, 0xe5, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xe6, 0xcd);
	mipi_dsi_dcs_write_seq(dsi, 0xe7, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xe8, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xe9, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xea, 0xd0);
	mipi_dsi_dcs_write_seq(dsi, 0xeb, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xee, 0xd0);
	mipi_dsi_dcs_write_seq(dsi, 0xef, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xf0, 0xcd);
	mipi_dsi_dcs_write_seq(dsi, 0xb5, 0x90);
	mipi_dsi_dcs_write_seq(dsi, 0xb6, 0x05, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x05, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x25);
	mipi_dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x05, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x13, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0x14, 0x12);
	mipi_dsi_dcs_write_seq(dsi, 0x19, 0x07);
	mipi_dsi_dcs_write_seq(dsi, 0x1b, 0x11);
	mipi_dsi_dcs_write_seq(dsi, 0x1f, 0x05);
	mipi_dsi_dcs_write_seq(dsi, 0x20, 0x90);
	mipi_dsi_dcs_write_seq(dsi, 0x26, 0x05);
	mipi_dsi_dcs_write_seq(dsi, 0x27, 0xb0);
	mipi_dsi_dcs_write_seq(dsi, 0x3f, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x48, 0x05);
	mipi_dsi_dcs_write_seq(dsi, 0x49, 0xb0);
	mipi_dsi_dcs_write_seq(dsi, 0x44, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0x45, 0xd0);
	mipi_dsi_dcs_write_seq(dsi, 0x5d, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0x5e, 0xd0);
	mipi_dsi_dcs_write_seq(dsi, 0x61, 0x05);
	mipi_dsi_dcs_write_seq(dsi, 0x62, 0xb0);
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x26);
	mipi_dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0xa1);
	mipi_dsi_dcs_write_seq(dsi, 0x04, 0x28);
	mipi_dsi_dcs_write_seq(dsi, 0x06, 0x30);
	mipi_dsi_dcs_write_seq(dsi, 0x0c, 0x11);
	mipi_dsi_dcs_write_seq(dsi, 0x0d, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x0f, 0x09);
	mipi_dsi_dcs_write_seq(dsi, 0x11, 0x12);
	mipi_dsi_dcs_write_seq(dsi, 0x12, 0x50);
	mipi_dsi_dcs_write_seq(dsi, 0x13, 0x6d);
	mipi_dsi_dcs_write_seq(dsi, 0x14, 0x93);
	mipi_dsi_dcs_write_seq(dsi, 0x15, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x16, 0x90);
	mipi_dsi_dcs_write_seq(dsi, 0x17, 0xa0);
	mipi_dsi_dcs_write_seq(dsi, 0x18, 0x86);
	mipi_dsi_dcs_write_seq(dsi, 0x19, 0x11);
	mipi_dsi_dcs_write_seq(dsi, 0x1a, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x1b, 0x0e);
	mipi_dsi_dcs_write_seq(dsi, 0x1c, 0xdc);
	mipi_dsi_dcs_write_seq(dsi, 0x22, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x23, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x2a, 0x11);
	mipi_dsi_dcs_write_seq(dsi, 0x2b, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x1d, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x1e, 0xd2);
	mipi_dsi_dcs_write_seq(dsi, 0x1f, 0xd2);
	mipi_dsi_dcs_write_seq(dsi, 0x20, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x21, 0x07);
	mipi_dsi_dcs_write_seq(dsi, 0x2f, 0x06);
	mipi_dsi_dcs_write_seq(dsi, 0x30, 0xd2);
	mipi_dsi_dcs_write_seq(dsi, 0x33, 0x66);
	mipi_dsi_dcs_write_seq(dsi, 0x34, 0x66);
	mipi_dsi_dcs_write_seq(dsi, 0x35, 0x66);
	mipi_dsi_dcs_write_seq(dsi, 0x39, 0x05);
	mipi_dsi_dcs_write_seq(dsi, 0x3a, 0xd2);
	mipi_dsi_dcs_write_seq(dsi, 0x3b, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x3f, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x40, 0xc8);
	mipi_dsi_dcs_write_seq(dsi, 0x41, 0xc8);
	mipi_dsi_dcs_write_seq(dsi, 0x42, 0xc8);
	mipi_dsi_dcs_write_seq(dsi, 0x43, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x44, 0xc8);
	mipi_dsi_dcs_write_seq(dsi, 0x45, 0x05);
	mipi_dsi_dcs_write_seq(dsi, 0x46, 0xc8);
	mipi_dsi_dcs_write_seq(dsi, 0x47, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x48, 0xc8);
	mipi_dsi_dcs_write_seq(dsi, 0x49, 0x05);
	mipi_dsi_dcs_write_seq(dsi, 0x4a, 0xc8);
	mipi_dsi_dcs_write_seq(dsi, 0x4b, 0x80);
	mipi_dsi_dcs_write_seq(dsi, 0x8b, 0x28);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x97, 0xa0);
	mipi_dsi_dcs_write_seq(dsi, 0x98, 0x86);
	mipi_dsi_dcs_write_seq(dsi, 0x99, 0x0f);
	mipi_dsi_dcs_write_seq(dsi, 0x9a, 0x9c);
	mipi_dsi_dcs_write_seq(dsi, 0x9b, 0x0e);
	mipi_dsi_dcs_write_seq(dsi, 0x9c, 0xdc);
	mipi_dsi_dcs_write_seq(dsi, 0x9d, 0x0f);
	mipi_dsi_dcs_write_seq(dsi, 0x9e, 0x9c);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xca, 0x4e);
	mipi_dsi_dcs_write_seq(dsi, 0xcb, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xa9, 0x79);
	mipi_dsi_dcs_write_seq(dsi, 0xaa, 0x7f);
	mipi_dsi_dcs_write_seq(dsi, 0xab, 0x85);
	mipi_dsi_dcs_write_seq(dsi, 0xac, 0x8b);
	mipi_dsi_dcs_write_seq(dsi, 0xad, 0x91);
	mipi_dsi_dcs_write_seq(dsi, 0xae, 0x97);
	mipi_dsi_dcs_write_seq(dsi, 0xaf, 0x9d);
	mipi_dsi_dcs_write_seq(dsi, 0xb0, 0xa3);
	mipi_dsi_dcs_write_seq(dsi, 0xb1, 0xa9);
	mipi_dsi_dcs_write_seq(dsi, 0xb2, 0xaf);
	mipi_dsi_dcs_write_seq(dsi, 0xb3, 0xb5);
	mipi_dsi_dcs_write_seq(dsi, 0xb4, 0xbb);
	mipi_dsi_dcs_write_seq(dsi, 0xb5, 0xc1);
	mipi_dsi_dcs_write_seq(dsi, 0xb6, 0xc7);
	mipi_dsi_dcs_write_seq(dsi, 0xb7, 0xcd);
	mipi_dsi_dcs_write_seq(dsi, 0xb8, 0xd3);
	mipi_dsi_dcs_write_seq(dsi, 0xb9, 0xd9);
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x27);
	mipi_dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xc3, 0x00);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x64, 0x16);
	mipi_dsi_dcs_write_seq(dsi, 0x6a, 0x16);
	mipi_dsi_dcs_write_seq(dsi, 0x70, 0x16);
	mipi_dsi_dcs_write_seq(dsi, 0x79, 0x16);
	mipi_dsi_dcs_write_seq(dsi, 0x7c, 0x16);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xa3, 0xf0);
	mipi_dsi_dcs_write_seq(dsi, 0xa4, 0xc0);
	mipi_dsi_dcs_write_seq(dsi, 0x22, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x23, 0x08);
	mipi_dsi_dcs_write_seq(dsi, 0x24, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x25, 0xd2);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x02, 0x7f);
	mipi_dsi_dcs_write_seq(dsi, 0x09, 0xee);
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0xf0);
	mipi_dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x10);
	mipi_dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x3b, 0x03, 0x08, 0x1a, 0x04, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0x35, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x53, 0x2c);
	mipi_dsi_dcs_write_seq(dsi, 0x68, 0x02, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x11, 0x00);
	msleep(100);
	mipi_dsi_dcs_write_seq(dsi, 0x29, 0x00);
	msleep(20);
...
static int gta4l_hlt_auo_init_sequence(struct panel_info *pinfo)
{
	...
	mipi_dsi_dcs_write_seq(dsi, 0x06, 0xc0);
	mipi_dsi_dcs_write_seq(dsi, 0x07, 0x37);
	mipi_dsi_dcs_write_seq(dsi, 0x08, 0x1e);
	mipi_dsi_dcs_write_seq(dsi, 0x0d, 0x23);
	mipi_dsi_dcs_write_seq(dsi, 0x0e, 0x55);
	mipi_dsi_dcs_write_seq(dsi, 0x0f, 0x32);
	mipi_dsi_dcs_write_seq(dsi, 0x30, 0x10);
	mipi_dsi_dcs_write_seq(dsi, 0x58, 0x60);
	mipi_dsi_dcs_write_seq(dsi, 0x75, 0xb1);
	mipi_dsi_dcs_write_seq(dsi, 0x88, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x94, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x95, 0xd7);
	mipi_dsi_dcs_write_seq(dsi, 0x96, 0xd7);
	mipi_dsi_dcs_write_seq(dsi, 0xf2, 0x51);
	mipi_dsi_dcs_write_seq(dsi, 0xb0, 0x00, 0x08, 0x00, 0x2f, 0x00, 0x63, 0x00, 0x88, 0x00, 0xa7, 0x00, 0xc0, 0x00, 0xd6, 0x00, 0xe8);
	mipi_dsi_dcs_write_seq(dsi, 0xb1, 0x00, 0xfa, 0x01, 0x32, 0x01, 0x59, 0x01, 0x97, 0x01, 0xc1, 0x02, 0x03, 0x02, 0x31, 0x02, 0x33);
	mipi_dsi_dcs_write_seq(dsi, 0xb2, 0x02, 0x61, 0x02, 0x97, 0x02, 0xc0, 0x02, 0xf2, 0x03, 0x1c, 0x03, 0x4a, 0x03, 0x5c, 0x03, 0x6d);
	mipi_dsi_dcs_write_seq(dsi, 0xb3, 0x03, 0x82, 0x03, 0x99, 0x03, 0xb1, 0x03, 0xc3, 0x03, 0xcc, 0x03, 0xcd);
	mipi_dsi_dcs_write_seq(dsi, 0xb4, 0x00, 0x08, 0x00, 0x2f, 0x00, 0x63, 0x00, 0x88, 0x00, 0xa7, 0x00, 0xc0, 0x00, 0xd6, 0x00, 0xe8);
	mipi_dsi_dcs_write_seq(dsi, 0xb5, 0x00, 0xfa, 0x01, 0x32, 0x01, 0x59, 0x01, 0x97, 0x01, 0xc1, 0x02, 0x03, 0x02, 0x31, 0x02, 0x33);
	mipi_dsi_dcs_write_seq(dsi, 0xb6, 0x02, 0x61, 0x02, 0x97, 0x02, 0xc0, 0x02, 0xf2, 0x03, 0x1c, 0x03, 0x4a, 0x03, 0x5c, 0x03, 0x6d);
	mipi_dsi_dcs_write_seq(dsi, 0xb7, 0x03, 0x82, 0x03, 0x99, 0x03, 0xb1, 0x03, 0xc3, 0x03, 0xcc, 0x03, 0xcd);
	mipi_dsi_dcs_write_seq(dsi, 0xb8, 0x00, 0x08, 0x00, 0x2f, 0x00, 0x63, 0x00, 0x88, 0x00, 0xa7, 0x00, 0xc0, 0x00, 0xd6, 0x00, 0xe8);
	mipi_dsi_dcs_write_seq(dsi, 0xb9, 0x00, 0xfa, 0x01, 0x32, 0x01, 0x59, 0x01, 0x97, 0x01, 0xc1, 0x02, 0x03, 0x02, 0x31, 0x02, 0x33);
	mipi_dsi_dcs_write_seq(dsi, 0xba, 0x02, 0x61, 0x02, 0x97, 0x02, 0xc0, 0x02, 0xf2, 0x03, 0x1c, 0x03, 0x4a, 0x03, 0x5c, 0x03, 0x6d);
	mipi_dsi_dcs_write_seq(dsi, 0xbb, 0x03, 0x82, 0x03, 0x99, 0x03, 0xb1, 0x03, 0xc3, 0x03, 0xcc, 0x03, 0xcd);
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x21);
	mipi_dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xb0, 0x00, 0x00, 0x00, 0x27, 0x00, 0x5b, 0x00, 0x80, 0x00, 0x9f, 0x00, 0xb8, 0x00, 0xce, 0x00, 0xe0);
	mipi_dsi_dcs_write_seq(dsi, 0xb1, 0x00, 0xf2, 0x01, 0x2a, 0x01, 0x51, 0x01, 0x8f, 0x01, 0xb9, 0x01, 0xfb, 0x02, 0x29, 0x02, 0x2b);
	mipi_dsi_dcs_write_seq(dsi, 0xb2, 0x02, 0x59, 0x02, 0x8f, 0x02, 0xb8, 0x02, 0xea, 0x03, 0x14, 0x03, 0x42, 0x03, 0x54, 0x03, 0x65);
	mipi_dsi_dcs_write_seq(dsi, 0xb3, 0x03, 0x7a, 0x03, 0x91, 0x03, 0xa9, 0x03, 0xbb, 0x03, 0xc4, 0x03, 0xc5);
	mipi_dsi_dcs_write_seq(dsi, 0xb0, 0x00, 0x00, 0x00, 0x27, 0x00, 0x5b, 0x00, 0x80, 0x00, 0x9f, 0x00, 0xb8, 0x00, 0xce, 0x00, 0xe0);
	mipi_dsi_dcs_write_seq(dsi, 0xb1, 0x00, 0xf2, 0x01, 0x2a, 0x01, 0x51, 0x01, 0x8f, 0x01, 0xb9, 0x01, 0xfb, 0x02, 0x29, 0x02, 0x2b);
	mipi_dsi_dcs_write_seq(dsi, 0xb2, 0x02, 0x59, 0x02, 0x8f, 0x02, 0xb8, 0x02, 0xea, 0x03, 0x14, 0x03, 0x42, 0x03, 0x54, 0x03, 0x65);
	mipi_dsi_dcs_write_seq(dsi, 0xb3, 0x03, 0x7a, 0x03, 0x91, 0x03, 0xa9, 0x03, 0xbb, 0x03, 0xc4, 0x03, 0xc5);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x02, 0x0f);
	mipi_dsi_dcs_write_seq(dsi, 0x03, 0x0f);
	mipi_dsi_dcs_write_seq(dsi, 0x04, 0x0e);
	mipi_dsi_dcs_write_seq(dsi, 0x05, 0x0e);
	mipi_dsi_dcs_write_seq(dsi, 0x06, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0x07, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0x08, 0x0c);
	mipi_dsi_dcs_write_seq(dsi, 0x09, 0x0c);
	mipi_dsi_dcs_write_seq(dsi, 0x0a, 0x26);
	mipi_dsi_dcs_write_seq(dsi, 0x0b, 0x26);
	mipi_dsi_dcs_write_seq(dsi, 0x0c, 0x29);
	mipi_dsi_dcs_write_seq(dsi, 0x0d, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x0e, 0x08);
	mipi_dsi_dcs_write_seq(dsi, 0x0f, 0x08);
	mipi_dsi_dcs_write_seq(dsi, 0x10, 0x23);
	mipi_dsi_dcs_write_seq(dsi, 0x11, 0x23);
	mipi_dsi_dcs_write_seq(dsi, 0x12, 0x22);
	mipi_dsi_dcs_write_seq(dsi, 0x13, 0x22);
	mipi_dsi_dcs_write_seq(dsi, 0x14, 0x05);
	mipi_dsi_dcs_write_seq(dsi, 0x15, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0x16, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x17, 0x2a);
	mipi_dsi_dcs_write_seq(dsi, 0x18, 0x0f);
	mipi_dsi_dcs_write_seq(dsi, 0x19, 0x0f);
	mipi_dsi_dcs_write_seq(dsi, 0x1a, 0x0e);
	mipi_dsi_dcs_write_seq(dsi, 0x1b, 0x0e);
	mipi_dsi_dcs_write_seq(dsi, 0x1c, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0x1d, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0x1e, 0x0c);
	mipi_dsi_dcs_write_seq(dsi, 0x1f, 0x0c);
	mipi_dsi_dcs_write_seq(dsi, 0x20, 0x26);
	mipi_dsi_dcs_write_seq(dsi, 0x21, 0x26);
	mipi_dsi_dcs_write_seq(dsi, 0x22, 0x29);
	mipi_dsi_dcs_write_seq(dsi, 0x23, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x24, 0x08);
	mipi_dsi_dcs_write_seq(dsi, 0x25, 0x08);
	mipi_dsi_dcs_write_seq(dsi, 0x26, 0x23);
	mipi_dsi_dcs_write_seq(dsi, 0x27, 0x23);
	mipi_dsi_dcs_write_seq(dsi, 0x28, 0x22);
	mipi_dsi_dcs_write_seq(dsi, 0x29, 0x22);
	mipi_dsi_dcs_write_seq(dsi, 0x2a, 0x05);
	mipi_dsi_dcs_write_seq(dsi, 0x2b, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0x2d, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x2f, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0x30, 0x42);
	mipi_dsi_dcs_write_seq(dsi, 0x33, 0x42);
	mipi_dsi_dcs_write_seq(dsi, 0x34, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0x37, 0x33);
	mipi_dsi_dcs_write_seq(dsi, 0x39, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x3a, 0x07);
	mipi_dsi_dcs_write_seq(dsi, 0x3b, 0xba);
	mipi_dsi_dcs_write_seq(dsi, 0x3d, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xab, 0x33);
	mipi_dsi_dcs_write_seq(dsi, 0x3f, 0x42);
	mipi_dsi_dcs_write_seq(dsi, 0x43, 0x42);
	mipi_dsi_dcs_write_seq(dsi, 0x47, 0x60);
	mipi_dsi_dcs_write_seq(dsi, 0x49, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x4a, 0x07);
	mipi_dsi_dcs_write_seq(dsi, 0x4b, 0xba);
	mipi_dsi_dcs_write_seq(dsi, 0x4c, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x4d, 0x21);
	mipi_dsi_dcs_write_seq(dsi, 0x4e, 0x43);
	mipi_dsi_dcs_write_seq(dsi, 0x4f, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x50, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x51, 0x34);
	mipi_dsi_dcs_write_seq(dsi, 0x52, 0x12);
	mipi_dsi_dcs_write_seq(dsi, 0x53, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x54, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x55, 0x84, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0x56, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0x58, 0x10);
	mipi_dsi_dcs_write_seq(dsi, 0x59, 0x10);
	mipi_dsi_dcs_write_seq(dsi, 0x5a, 0x07);
	mipi_dsi_dcs_write_seq(dsi, 0x5b, 0xba);
	mipi_dsi_dcs_write_seq(dsi, 0x5c, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x5d, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x5e, 0x00, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0x60, 0x96);
	mipi_dsi_dcs_write_seq(dsi, 0x61, 0xd0);
	mipi_dsi_dcs_write_seq(dsi, 0x63, 0x70);
	mipi_dsi_dcs_write_seq(dsi, 0x91, 0x40);
	mipi_dsi_dcs_write_seq(dsi, 0x92, 0xd9);
	mipi_dsi_dcs_write_seq(dsi, 0x93, 0x1a);
	mipi_dsi_dcs_write_seq(dsi, 0x94, 0x08);
	mipi_dsi_dcs_write_seq(dsi, 0x96, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x97, 0xc2);
	mipi_dsi_dcs_write_seq(dsi, 0xb6, 0x05, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x05, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xc2, 0xc6);
	mipi_dsi_dcs_write_seq(dsi, 0xc3, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xc4, 0x20);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xc9, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xca, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xcf, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0xd0, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0xd1, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0xd2, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0xd3, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xd4, 0xff);
	mipi_dsi_dcs_write_seq(dsi, 0xd5, 0x0f);
	mipi_dsi_dcs_write_seq(dsi, 0xd6, 0x77);
	mipi_dsi_dcs_write_seq(dsi, 0xdb, 0x71);
	mipi_dsi_dcs_write_seq(dsi, 0xdc, 0xda);
	mipi_dsi_dcs_write_seq(dsi, 0xdf, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xe0, 0xda);
	mipi_dsi_dcs_write_seq(dsi, 0xe1, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xe2, 0xda);
	mipi_dsi_dcs_write_seq(dsi, 0xe3, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xe4, 0xda);
	mipi_dsi_dcs_write_seq(dsi, 0xe5, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xe6, 0xda);
	mipi_dsi_dcs_write_seq(dsi, 0xef, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xf0, 0xda);
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x25);
	mipi_dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x05, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x13, 0x03);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x1f, 0x07);
	mipi_dsi_dcs_write_seq(dsi, 0x20, 0xba);
	mipi_dsi_dcs_write_seq(dsi, 0x25, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x26, 0x07);
	mipi_dsi_dcs_write_seq(dsi, 0x27, 0xba);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x45, 0xba);
	mipi_dsi_dcs_write_seq(dsi, 0x48, 0x07);
	mipi_dsi_dcs_write_seq(dsi, 0x49, 0xba);
	mipi_dsi_dcs_write_seq(dsi, 0x6b, 0x62);
	mipi_dsi_dcs_write_seq(dsi, 0x6c, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0x6d, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0x6e, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0x6f, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0x70, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0x71, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0x72, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0x73, 0x0d);
	mipi_dsi_dcs_write_seq(dsi, 0x78, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x79, 0xff);
	mipi_dsi_dcs_write_seq(dsi, 0x7a, 0x0f);
	mipi_dsi_dcs_write_seq(dsi, 0x7b, 0x77);
	mipi_dsi_dcs_write_seq(dsi, 0x7c, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x7d, 0xff);
	mipi_dsi_dcs_write_seq(dsi, 0x7e, 0x0f);
	mipi_dsi_dcs_write_seq(dsi, 0x7f, 0x77);
	mipi_dsi_dcs_write_seq(dsi, 0x86, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0x89, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0x8a, 0x13);
	mipi_dsi_dcs_write_seq(dsi, 0x5b, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x5c, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x5d, 0x07);
	mipi_dsi_dcs_write_seq(dsi, 0x5e, 0xba);
	mipi_dsi_dcs_write_seq(dsi, 0x61, 0x07);
	mipi_dsi_dcs_write_seq(dsi, 0x62, 0xba);
	mipi_dsi_dcs_write_seq(dsi, 0x67, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x68, 0x04);
	mipi_dsi_dcs_write_seq(dsi, 0xc2, 0x40);
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x26);
	mipi_dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0xa1);
	mipi_dsi_dcs_write_seq(dsi, 0x04, 0x28);
	mipi_dsi_dcs_write_seq(dsi, 0x06, 0x32);
	mipi_dsi_dcs_write_seq(dsi, 0x0a, 0xf3);
	mipi_dsi_dcs_write_seq(dsi, 0x0c, 0x11);
	mipi_dsi_dcs_write_seq(dsi, 0x0d, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x0f, 0x09);
	mipi_dsi_dcs_write_seq(dsi, 0x11, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x12, 0x50);
	mipi_dsi_dcs_write_seq(dsi, 0x13, 0x71);
	mipi_dsi_dcs_write_seq(dsi, 0x14, 0x6f);
	mipi_dsi_dcs_write_seq(dsi, 0x16, 0x90);
	mipi_dsi_dcs_write_seq(dsi, 0x19, 0x0f);
	mipi_dsi_dcs_write_seq(dsi, 0x1a, 0xff);
	mipi_dsi_dcs_write_seq(dsi, 0x1b, 0x0e);
	mipi_dsi_dcs_write_seq(dsi, 0x1c, 0xec);
	mipi_dsi_dcs_write_seq(dsi, 0x1d, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x1e, 0xd9);
	mipi_dsi_dcs_write_seq(dsi, 0x1f, 0xd9);
	mipi_dsi_dcs_write_seq(dsi, 0x20, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x21, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x24, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x25, 0xd9);
	mipi_dsi_dcs_write_seq(dsi, 0x2a, 0x0f);
	mipi_dsi_dcs_write_seq(dsi, 0x2b, 0xff);
	mipi_dsi_dcs_write_seq(dsi, 0x2f, 0x06);
	mipi_dsi_dcs_write_seq(dsi, 0x30, 0xd9);
	mipi_dsi_dcs_write_seq(dsi, 0x33, 0x66);
	mipi_dsi_dcs_write_seq(dsi, 0x34, 0x66);
	mipi_dsi_dcs_write_seq(dsi, 0x35, 0x66);
	mipi_dsi_dcs_write_seq(dsi, 0x36, 0x11);
	mipi_dsi_dcs_write_seq(dsi, 0x37, 0x11);
	mipi_dsi_dcs_write_seq(dsi, 0x38, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x39, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x3a, 0xda);
	mipi_dsi_dcs_write_seq(dsi, 0xc9, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x27);
	mipi_dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x56, 0x06);
	mipi_dsi_dcs_write_seq(dsi, 0x58, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x59, 0x46);
	mipi_dsi_dcs_write_seq(dsi, 0x5a, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x5b, 0x13);
	mipi_dsi_dcs_write_seq(dsi, 0x5c, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x5d, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x5e, 0x20);
	mipi_dsi_dcs_write_seq(dsi, 0x5f, 0x10);
	mipi_dsi_dcs_write_seq(dsi, 0x60, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x61, 0x11);
	mipi_dsi_dcs_write_seq(dsi, 0x62, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x63, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x64, 0x21);
	mipi_dsi_dcs_write_seq(dsi, 0x65, 0x0f);
	mipi_dsi_dcs_write_seq(dsi, 0x66, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x67, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x68, 0x22);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x23, 0x08);
	mipi_dsi_dcs_write_seq(dsi, 0x24, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x25, 0xd4);
	mipi_dsi_dcs_write_seq(dsi, 0x27, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x28, 0x1a);
	mipi_dsi_dcs_write_seq(dsi, 0x29, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x2a, 0x1a);
	mipi_dsi_dcs_write_seq(dsi, 0x2b, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x2d, 0x1a);
	mipi_dsi_dcs_write_seq(dsi, 0x64, 0x41);
	mipi_dsi_dcs_write_seq(dsi, 0x67, 0x41);
	mipi_dsi_dcs_write_seq(dsi, 0x68, 0x23);
	mipi_dsi_dcs_write_seq(dsi, 0x6a, 0x41);
	mipi_dsi_dcs_write_seq(dsi, 0x79, 0x41);
	mipi_dsi_dcs_write_seq(dsi, 0x7c, 0x41);
	mipi_dsi_dcs_write_seq(dsi, 0x7f, 0x41);
	mipi_dsi_dcs_write_seq(dsi, 0x88, 0x41);
	mipi_dsi_dcs_write_seq(dsi, 0x8b, 0xc9);
	mipi_dsi_dcs_write_seq(dsi, 0x97, 0x3c);
	mipi_dsi_dcs_write_seq(dsi, 0x98, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0x99, 0x95);
	mipi_dsi_dcs_write_seq(dsi, 0x9a, 0x06);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xa5, 0x0f);
	mipi_dsi_dcs_write_seq(dsi, 0xe8, 0x2a);
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x23);
	mipi_dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0x00, 0x80);
	mipi_dsi_dcs_write_seq(dsi, 0x07, 0x00);
...
static const struct drm_display_mode gta4l_modes[] = {
	{
		.clock = (1200 + 52 + 1 + 51) * (2000 + 7 + 1 + 26) * 60 / 1000,
		.hdisplay = 1200,
		.hsync_start = 1200 + 52,
		.hsync_end = 1200 + 52 + 1,
		.htotal = 1200 + 52 + 1 + 51,
...
static const struct panel_desc gta4l_lide_hsd_desc = {
	.modes = gta4l_modes,
	.num_modes = ARRAY_SIZE(gta4l_modes),
	.width_mm = 135,
	.height_mm = 226,
	.bpc = 8,
	.lanes = 4,
